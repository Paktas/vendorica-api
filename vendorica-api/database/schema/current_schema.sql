...
-- Generated from: Migration 002 (add_user_preferences)
-- Last updated: 2024-12-31
-- Description: Complete schema including all applied migrations
...
-- Users table (includes preferences from migration 002)
CREATE TABLE users (
    id UUID PRIMARY KEY,
...
COMMENT ON TABLE contracts IS 'Contracts between organizations and vendors';
COMMENT ON TABLE audit_trail IS 'Audit log of all system changes';
